...
type ChaosMonkeyConfigurationInterface interface {
	...
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha1.ChaosMonkeyConfigurationList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ChaosMonkeyConfiguration, err error)
...
func newChaosMonkeyConfigurations(c *ChaosMonkeyConfigurationV1alpha1Client, namespace string) *chaosMonkeyConfigurations {
...
func (c *chaosMonkeyConfigurations) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ChaosMonkeyConfiguration, err error) {
...
func (c *chaosMonkeyConfigurations) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ChaosMonkeyConfigurationList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ChaosMonkeyConfigurationList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("chaosmonkeyconfigurations").
...
func (c *chaosMonkeyConfigurations) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *chaosMonkeyConfigurations) Create(ctx context.Context, chaosMonkeyConfiguration *v1alpha1.ChaosMonkeyConfiguration, opts v1.CreateOptions) (result *v1alpha1.ChaosMonkeyConfiguration, err error) {
	result = &v1alpha1.ChaosMonkeyConfiguration{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("chaosmonkeyconfigurations").
...
func (c *chaosMonkeyConfigurations) Update(ctx context.Context, chaosMonkeyConfiguration *v1alpha1.ChaosMonkeyConfiguration, opts v1.UpdateOptions) (result *v1alpha1.ChaosMonkeyConfiguration, err error) {
	result = &v1alpha1.ChaosMonkeyConfiguration{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("chaosmonkeyconfigurations").
...
func (c *chaosMonkeyConfigurations) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *chaosMonkeyConfigurations) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ChaosMonkeyConfiguration, err error) {
	result = &v1alpha1.ChaosMonkeyConfiguration{}
